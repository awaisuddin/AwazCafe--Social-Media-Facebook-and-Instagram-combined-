...
<head>
    <title><? echo lang('dashboard'); ?> | Bekhoof</title>
    <admin charset="UTF-8">
    <admin name="description" content="Bekhoof provides a social network cafe keeps you updated & motivated everytime you work.">
