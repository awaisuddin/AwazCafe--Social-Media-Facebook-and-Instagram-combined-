...
<style type="text/css">
	...
	.navbar-inverse{
		background-image: url(<?php echo $dircheckPath."imgs/main_icons/awazcafecover.jpg"?>);
...
<nav class="navbar navbar-inverse" style="position:fixed;top:0;right:0;left:0;z-index: 2;">
    <div class="container-fluid" style="width: 100%;">
        <div class="navbar-header" style="float: <?php echo lang('float'); ?>;">
            ...
            <a class="" href="<?php echo $dircheckPath; ?>home"><img style="  width:150px  ;height: 50px;" src="<?php echo $dircheckPath."imgs/main_icons/awaz logo1.jpg"?>"> </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="<?php echo lang('ul_navbar_nav1'); ?>">
                ...
                ?>
                <li><a href="<?php echo $homePath; ?>" style="padding: 14px 10px;"><span style="font-size: 17px;" class="fa fa-home"></span> </a></li>
                <li><a href="javascript:void(0);" style="padding: 16px 10px;" id="nav_Noti_Btn"><span class="fa fa-bell"></span> <span id="notificationsCount"></span></a>
                ...
                <li><a href="<?php echo $dircheckPath; ?>messages/" style="padding: 16px 10px;"><span class="fa fa-envelope"></span> <span id="messagesCount"></span></a>
                </li>
