...
<ul class="wpost_tab">
    ...
    <button class="wpost_tablinks" onclick="wpost_tabs(event, 'w_text')"><span style="color: cornflowerblue;margin: 0px 5px;" class="fa fa-pencil"></span>  </button>
    </li>
    <li id="wt_photo" style="float:<?php echo lang('w_post_li'); ?>;">
    <button class="wpost_tablinks" onclick="wpost_tabs(event, 'w_photo')"><span style="color: #4CAF50;margin: 0px 5px;" class="fa fa-camera"></span>  </button>
    </li>
    <li id="wt_location" style="float:<?php echo lang('w_post_li'); ?>;">
    <button class="wpost_tablinks" onclick="wpost_tabs(event, 'w_title')"><span style="color: #ffb300;margin: 0px 5px;" class="fa fa-quote-right"></span>  </button>
    </li>
