...
$c_num = $c->rowCount();
if ($c_num > 0){
    echo "<span id='likeUnlike_$get_post_id' style='cursor:pointer'><span onclick=\"likeUnlike('$get_post_id')\" align='left' style='color:#ff928a;font-size:25px' data-toggle='tooltip' data-placement='top' title='".lang('u_liked_this')."' id='punlike'><span class=\"fa fa-heart\"></span></span></span>";
}else{
    echo "<span id='likeUnlike_$get_post_id' style='cursor:pointer'><span onclick=\"likeUnlike('$get_post_id')\" align='left' style='color:#ff928a;font-size:25px' data-toggle='tooltip' data-placement='top' title='".lang('liked')."' id='plike'><span class=\"fa fa-heart-o\"></span></span></span>";
}
...
echo "<a href=\"javascript:void(0);\" onclick=\"fcomment('$get_post_id')\" class='post_like_comment_shareA' align='left' data-toggle='tooltip' style='color:#ff928a;font-size:25px' data-placement='top' title='".lang('comment')."'><span class=\"fa fa-commenting\"></span></a>
	  <a href=\'javascript:void(0);\' onclick=\"sharePost('$get_post_id','$check_path')\" class='post_like_comment_shareA' data-toggle='tooltip' align='right' style='color:#ff928a;font-size:25px' data-placement='top' title='".lang('share_now')."'><span class=\"fa fa-share-alt\"></span></a>
