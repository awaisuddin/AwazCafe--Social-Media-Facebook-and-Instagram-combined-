...
<head>
    <title><? echo lang('welcome'); ?> | AwazCafe</title>
    <meta charset="UTF-8">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">Bekhoof</a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> Bekhoof</h3>
        <p align="center" style="color: #999; margin-bottom: 25px;"><? echo lang('Bekhoof_main_string'); ?>.</p>
            <div style="display: flex;">
                ...
                <div style="width: 100%;text-align: center;">
                    <img src="imgs/main_icons/bekhoof.jpg" alt="Bekhoof" style="width: 80%;" />
                </div>
            </div>
        </div>
