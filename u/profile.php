...
<head>
    <title><?php echo $row_username; ?> | AwazCafe</title>
    <meta charset="UTF-8">
    <meta name="description" content="Bekhoof provides a social network cafe keeps you updated & motivated everytime you work">
    <meta name="keywords" content="social network,social media,Bekhoof,meet,free platform">
    <meta name="author" content="Mohammed Awaisuddin Nawaz Khan">
	...
	body{
	background-image: url("../imgs/main_icons/awaz background.jpg");
...
<!--=============================[ Container ]=====================================-->
        ...
        <div class="profile_menu">
			...
			<div class="" style=" overflow: visible;position: relative;">
            <?
            if ($row_username == $_SESSION['Username']) {
                $userActive = "#4CAF50";
            }else{
        ...
        ?>
        <div class="profile_picture_img profile_ppicture" style="position:center; top: -250px;  <?php echo $profile_pic_border_var;?>">
        ...
        <div class="profile_picture"  >
            <p style="position:center; top: 100px;  "class ="profileMenuItem" align="center">@<?php echo $row_username;?></p>
        ...
        <div class="user_info">
            ...
            <p class="profile_mynotepad_box">
                ...
                <a href="../mynotepad/new" class="green_flat_btn"><?php echo lang('new_note');?></a><br />
				<br />
